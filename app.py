...
def generate():
    ...
    # Indicação de que a resposta deve vir de um sommelier
    prompt = f'Responda como um sommelier falando com alguém leigo. Mas seja bem culto e dê uma resposta detalhada, gerando curiosidade no cliente. Se possível, vinhos mais comuns. {question}  '
